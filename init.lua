...
--
--  See `:help wincmd` for a list of all window commands
vim.keymap.set('n', '<leader><Tab>', ':tabnew<CR>', { noremap = true, silent = true })
...
local env = require 'lua.config.env'
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'php', 'blade', 'phpdoc', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
  ...
  { import = 'plugins' },
  { import = 'extra' },
  env.is_dev and { import = 'dev' } or nil,
